    ...
    Column(
        ...
        Row(
            ...
            OutlinedTextField(
                modifier = Modifier
                    .weight(1f)
                    .border(color = Color.Black, shape = RoundedCornerShape(8.dp), width = 2.dp),
                value = city,
                onValueChange = { city = it },

                placeholder = {
                    Text(text = "Search Location", color = Color.Black)
                },
                leadingIcon = {
...
fun WeatherDetails(data : WeatherModel) {
    Column(
        ...
        Row(
            ...
            Text1(text = data.location.country, fontSize = 18.sp, color = Color.Black)
        }
        ...
        Card {
            Column(
                ...
                Row(
                    ...
                    WeatherKeyVal("Feels_like",data.current.feelslike_c)
